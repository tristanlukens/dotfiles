# This plugin comes from https://github.com/softmoth/zsh-vim-mode.
# It's easier to just paste this here instead of using a plugin mananger, especially since this is the only plugin I use.
